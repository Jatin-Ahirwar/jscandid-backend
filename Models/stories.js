...
const storiesModel = new mongoose.Schema({
    ...
    storiesimages:[{
        storiesfunction:[{
            functionname:{
                type:String,
                required:[true,"functionname is required"],
                maxlength:[13,"functionname should not exceed more than 15 character"],
                minlength:[2,"functionname should have atleast 6 characters"]    
            },
            functionimages:[{
                type:String
            }]
